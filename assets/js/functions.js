...
(function ($) {
    ...
    INSPIRO.header = {
        ...
        topBar: function () {
            if ($topbar.length > 0) {
                $("#topbar .topbar-dropdown .topbar-form").each(function (index,
                                                                          element) {
                    if (
        ...
        mainMenu: function () {
            if ($mainMenu.length > 0) {
                ...
                $(window).breakpoints("greaterEqualTo", "lg", function () {
                    ...
                    $(".dropdown:not(.mega-menu-item) ul ul").each(function (index,
                                                                             element) {
                        if (
                            $window.width() -
    ...
    INSPIRO.elements = {
        functions: function () {
            ...
            INSPIRO.elements.backgroundOverlay();
            ...
            if ($parallax.length > 0) {
                ...
                $parallax.each(function () {
                    var
                        ...
                        elemMarginTop = $elem.attr("data-margintop"),
                        elemImageVelocity = $elem.attr("data-velocity") || "-.140"
                    ;
                    $elem.prepend(
                        '<div class="parallax-container" data-lazy-background="' + elemImageSrc + '"  ' +
                            'data-velocity="' + elemImageVelocity + '" ' +
                            'style="background: url(' + elemImageSrc + '); background-position-y: '+elemMarginTop+'">' +
                        '</div>'
                    );
            ...
            $shape_divider.each(function () {
                ...
                if ($body.hasClass("b--desktop")) {
                    if (elem.options.height) {
                        ...
                        svg.setAttribute("preserveAspectRatio", "none");
                        svg.setAttribute("style", "height:" + Number(svg.height.baseVal.valueInSpecifiedUnits).toFixed() / 1.2 + "px");
                        // svg.setAttribute("height", "100%");
                        svg.setAttribute("width", "100%");
                    }
                } else {
                ...
                elem.append(svg);
                $("svg title", $shape_divider).remove();
            });
        },
        ...
        gridLayout: function () {
            if ($gridLayout.length > 0) {
                ...
                var isotopeRTL = !INSPIRO.core.rtlStatus();
                    ...
                    ajax: {
                        ...
                        callbacks: {
                            ...
                            parseAjax : function (mfpResponse) {
                                // console.log("mfpResponse : ", mfpResponse);
                            }
                        }
                    },
                    inline: {
